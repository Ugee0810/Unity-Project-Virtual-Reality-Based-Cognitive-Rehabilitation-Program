...
public class QuizManager : MonoBehaviour
{
    ...
    //size : 49 Letters (집중 평화 용서 감사 침착 정의 조화 자유 정직 지혜 친절 이해 활력 영감 공감 겸손 힘 지성 고요 결단 사랑 관용 자비 부드러움 축복 생명 믿음 젊음 자신감 덕성 행복 영혼 민첩성 건강 충만 일관성 끈기 목적 성취 풍요 성공 숙달 능력 에너지 소명 침묵 직관 재생 소생)
