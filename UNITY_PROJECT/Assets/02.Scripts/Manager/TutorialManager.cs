...
public class TutorialManager : MonoBehaviour
{
    ...
    public (Vector3, Vector2, Quaternion) XR_TutoCanvasSize()
    {
        if      (tutorialStep == 0)
            ...
            return (new Vector3(0f, 1.3f, 0.95f), new Vector2(150f, 20f), Quaternion.Euler(30f, 0f, 0f));
            ...
            return (new Vector3(0f, 1.2f, 0.8f), new Vector2(180f, 40f), Quaternion.Euler(30f, 0f, 0f));
        else
    ...
    void Step2()
    {
        ...
        // 안내 문구 강조
        textTutoOriginal.text = "<rainb f=0.2>Original</rainb>";
    ...
    void Step4()
    {
        ...
        // 안내 문구 강조 ON
        textTutoEasy.text = "<rainb f=0.2>쉬움</rainb>";
    ...
    void Step5()
    {
        ...
        // 안내 문구 강조 ON
        textTutoPlay.text = "<rainb f=0.2>시 작</rainb>";
    ...
    public void TutorialListRenewal()
    {
        if (isTutorial)
        {
            ...
            // 분석한 BPM을 텍스트에 저장
            tutorialMusicElementPrefab.transform.GetChild(2).gameObject.GetComponent<Text>().text = $"BPM : {UniBpmAnalyzer.AnalyzeBpm(tutorialMusicElementPrefab.transform.GetChild(3).gameObject.GetComponent<AudioSource>().clip)}";
            // (float)MusicLength to (string)PlayTime
            tutorialMusicElementPrefab.transform.GetChild(1).gameObject.GetComponent<Text>().text = GameManager.instance.TimeFormatter(tutorialMusicElementPrefab.transform.GetChild(3).gameObject.GetComponent<AudioSource>().clip.length, false);
            // textTitle.text ← customMusicElements.AudioSource.text
            tutorialMusicElementPrefab.transform.GetChild(0).gameObject.GetComponent<Text>().text = tutorialMusicElementPrefab.transform.GetChild(3).gameObject.GetComponent<AudioSource>().clip.name;
        }
    }
